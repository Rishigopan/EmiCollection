...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Modal -->
        <div class="modal modal-xl " id="ViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function(data,type,row,meta){
                            return '<a style="text-decoration:none" class="viewDetails"  id="' + data.cust_id + '" href= "">' + data.cust_name + '</a>'
                        }
                    },
                    {
                        data: 'cust_phone'
            ...
            $('#itemWiseReport tbody').on('click', '.viewDetails', function(s) {
                ...
                $.ajax({
                    type: "POST",
                    url: "CustomerWiseReportViewData.php",
                    data: {CustId: CustId},
                    beforeSend: function() {
                        //$('#delModal').modal('hide');
            ...
            //view order installment view 
            $('#profile-tab').click(function(){
                var CustomerOrderId = $(this).val();
                console.log(CustomerOrderId);
                $.ajax({
                    type: "POST",
                    url: "CustomerWiseReportViewOrderDetailsData.php",
            ...
            $('#ViewModal #CustomerDetailed').on('change', '#CustomerProdutSelect', function(s) {
                ...
                $.ajax({
                    type: "POST",
                    url: "CustomerWiseReportViewInstallment.php",
